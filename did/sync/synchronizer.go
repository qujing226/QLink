...
type SyncConfig struct {
	...
	ConflictResolution string        `json:"conflict_resolution"` // "timestamp", "majority", "manual"
}
...
type DIDSyncData struct {
	DIDs     []*did.DIDDocument `json:"dids"`
	Version  int64              `json:"version"`
...
func NewSynchronizer(nodeID string, registry *did.DIDRegistry, p2pNetwork *network.P2PNetwork, config *SyncConfig) *Synchronizer {
	if config == nil {
		config = &SyncConfig{
