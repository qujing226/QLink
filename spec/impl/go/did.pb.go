...
const file_did_proto_rawDesc = "" +
	...
	"\x06result\x12\x05\xbaH\x02\b\x01B\fZ\n" +
	"./didprotob\x06proto3"
...
var file_did_proto_goTypes = []any{
	(Status_Code)(0),            // 0: didproto.Status.Code
	(*Packet)(nil),              // 1: didproto.Packet
	(*Header)(nil),              // 2: didproto.Header
	(*Status)(nil),              // 3: didproto.Status
	(*KEMInit)(nil),             // 4: didproto.KEMInit
	(*KEMConfirm)(nil),          // 5: didproto.KEMConfirm
	(*SecureMessage)(nil),       // 6: didproto.SecureMessage
	(*DIDDocumentRequest)(nil),  // 7: didproto.DIDDocumentRequest
	(*DIDDocumentResponse)(nil), // 8: didproto.DIDDocumentResponse
}
var file_did_proto_depIdxs = []int32{
	2, // 0: didproto.Packet.header:type_name -> didproto.Header
	4, // 1: didproto.Packet.kem_init:type_name -> didproto.KEMInit
	5, // 2: didproto.Packet.kem_confirm:type_name -> didproto.KEMConfirm
	6, // 3: didproto.Packet.secure_message:type_name -> didproto.SecureMessage
	7, // 4: didproto.Packet.did_request:type_name -> didproto.DIDDocumentRequest
	8, // 5: didproto.Packet.did_response:type_name -> didproto.DIDDocumentResponse
	3, // 6: didproto.Packet.status:type_name -> didproto.Status
	0, // 7: didproto.Status.code:type_name -> didproto.Status.Code
